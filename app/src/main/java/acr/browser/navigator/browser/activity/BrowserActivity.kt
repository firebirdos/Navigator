...
package acr.browser.navigator.browser.activity

import acr.browser.navigator.AppTheme
import acr.browser.navigator.IncognitoActivity
import acr.browser.navigator.R
import acr.browser.navigator.browser.*
...
import acr.browser.navigator.browser.tabs.TabsDesktopView
import acr.browser.navigator.browser.tabs.TabsDrawerView
import acr.browser.navigator.controller.UIController
import acr.browser.navigator.database.Bookmark
import acr.browser.navigator.database.HistoryEntry
import acr.browser.navigator.database.SearchSuggestion
import acr.browser.navigator.database.WebPage
...
import acr.browser.navigator.di.*
import acr.browser.navigator.dialog.BrowserDialog
import acr.browser.navigator.dialog.DialogItem
import acr.browser.navigator.dialog.LightningDialogBuilder
import acr.browser.navigator.extensions.*
import acr.browser.navigator.html.bookmark.BookmarkPageFactory
import acr.browser.navigator.html.history.HistoryPageFactory
import acr.browser.navigator.html.homepage.HomePageFactory
import acr.browser.navigator.icon.TabCountView
import acr.browser.navigator.interpolator.BezierDecelerateInterpolator
import acr.browser.navigator.log.Logger
import acr.browser.navigator.notifications.IncognitoNotification
import acr.browser.navigator.reading.activity.ReadingActivity
import acr.browser.navigator.search.SearchEngineProvider
import acr.browser.navigator.search.SuggestionsAdapter
import acr.browser.navigator.settings.activity.SettingsActivity
import acr.browser.navigator.ssl.SslState
import acr.browser.navigator.ssl.createSslDrawableForState
import acr.browser.navigator.ssl.showSslDialog
import acr.browser.navigator.utils.*
import acr.browser.navigator.view.*
import acr.browser.navigator.view.SearchView
import acr.browser.navigator.view.find.FindResults
