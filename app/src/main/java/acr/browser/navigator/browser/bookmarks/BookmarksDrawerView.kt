package acr.browser.navigator.browser.bookmarks

import acr.browser.navigator.R
import acr.browser.navigator.adblock.allowlist.AllowListModel
import acr.browser.navigator.animation.AnimationUtils
import acr.browser.navigator.browser.BookmarksView
import acr.browser.navigator.browser.TabsManager
...
import acr.browser.navigator.di.MainScheduler
import acr.browser.navigator.di.NetworkScheduler
import acr.browser.navigator.di.injector
...
import acr.browser.navigator.extensions.color
import acr.browser.navigator.extensions.drawable
import acr.browser.navigator.extensions.inflater
import acr.browser.navigator.favicon.FaviconModel
import acr.browser.navigator.reading.activity.ReadingActivity
import acr.browser.navigator.utils.isSpecialUrl
