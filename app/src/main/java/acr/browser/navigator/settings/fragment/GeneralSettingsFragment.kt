...
import acr.browser.navigator.browser.ProxyChoice
import acr.browser.navigator.constant.SCHEME_BLANK
import acr.browser.navigator.constant.SCHEME_BOOKMARKS
import acr.browser.navigator.constant.SCHEME_HOMEPAGE
import acr.browser.navigator.di.injector
import acr.browser.navigator.dialog.BrowserDialog
import acr.browser.navigator.extensions.withSingleChoiceItems
import acr.browser.navigator.preference.UserPreferences
import acr.browser.navigator.search.SearchEngineProvider
import acr.browser.navigator.search.Suggestions
import acr.browser.navigator.search.engine.BaseSearchEngine
import acr.browser.navigator.search.engine.CustomSearch
import acr.browser.navigator.utils.FileUtils
import acr.browser.navigator.utils.ProxyUtils
import acr.browser.navigator.utils.ThemeUtils
