package acr.browser.navigator.adblock

import acr.browser.navigator.R
import acr.browser.navigator.adblock.source.HostsDataSourceProvider
import acr.browser.navigator.adblock.source.HostsResult
import acr.browser.navigator.adblock.util.BloomFilter
import acr.browser.navigator.adblock.util.DefaultBloomFilter
import acr.browser.navigator.adblock.util.DelegatingBloomFilter
import acr.browser.navigator.adblock.util.`object`.JvmObjectStore
import acr.browser.navigator.adblock.util.`object`.ObjectStore
import acr.browser.navigator.adblock.util.hash.MurmurHashHostAdapter
import acr.browser.navigator.adblock.util.hash.MurmurHashStringAdapter
import acr.browser.navigator.database.adblock.Host
import acr.browser.navigator.database.adblock.HostsRepository
import acr.browser.navigator.database.adblock.HostsRepositoryInfo
import acr.browser.navigator.di.DatabaseScheduler
import acr.browser.navigator.di.MainScheduler
import acr.browser.navigator.extensions.toast
