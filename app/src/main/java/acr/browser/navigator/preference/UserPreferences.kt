package acr.browser.navigator.preference

import acr.browser.navigator.AppTheme
import acr.browser.navigator.browser.ProxyChoice
import acr.browser.navigator.browser.SearchBoxDisplayChoice
import acr.browser.navigator.browser.SearchBoxModel
import acr.browser.navigator.constant.DEFAULT_ENCODING
import acr.browser.navigator.constant.SCHEME_HOMEPAGE
import acr.browser.navigator.device.ScreenSize
import acr.browser.navigator.di.UserPrefs
import acr.browser.navigator.preference.delegates.*
import acr.browser.navigator.search.SearchEngineProvider
import acr.browser.navigator.search.engine.GoogleSearch
import acr.browser.navigator.utils.FileUtils
import acr.browser.navigator.view.RenderingMode
